chrome.browserAction.onClicked.addListener(function (s) {chrome.tabs.create({'url': chrome.extension.getURL('sms.html')}, function (t) {});});
...
async function main() {
    ...
    if (phones.length !== 0 && message.length !== 0) {
        for (let phone of phones) {
            let res = await fetch(`https://thsms.com/api/send-sms`,{
                method:"POST",
                headers:{
                    "Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC93d3cudGhzbXMuY29tXC9hcGkta2V5IiwiaWF0IjoxNjQ1MjkzNTY2LCJuYmYiOjE2NDkzMjEyMDUsImp0aSI6Imt3ZmpDaEROeFdrVHB6WW0iLCJzdWIiOjEwMzQ1MSwicHJ2IjoiMjNiZDVjODk0OWY2MDBhZGIzOWU3MDFjNDAwODcyZGI3YTU5NzZmNyJ9.i9HfT2ysDIHle-DXLxnuWbkBEQZ0W5eWk_LIwOlvWEM",
    ...
    <div class="container mx-auto p-3">
            ...
            <nav class="bg-white px-2 sm:px-4 py-3.5 rounded dark:bg-gray-800">
                <div class="container w-full md:w-[960px] flex flex-wrap justify-between items-center mx-auto">
                   <a class="flex items-center" href="/"><span class="self-center text-2xl font-semibold whitespace-nowrap text-blue-400 dark:text-white">SMS UI</span></a><button class="inline-flex items-center p-2 ml-3 text-xl text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"><i class="fas fa-align-justify"></i></button>
            ...
            <div class="text-center p-3">
                <h1 class="text-4xl text-white underline">เว็บยิงข้อความ SMS </h1>
            </div>
            <!-- header -->
                ...
                <div class="grid md:grid-cols-1 sm:flex justify-center">
                    <div class="w-[500px] my-4 sm:my-0">
                        ...
                        <div class="text-blue-400 text-2xl">
                            <i class="fa-brands fa-facebook text-blue-500"></i><a class="text-white hover:underline" href="https://www.facebook.com/profile.php?id=100024033106711">  Facebook</a>
                            <br><i class="fa-brands fa-youtube text-red-500"></i><a class="text-white hover:underline" href="https://www.youtube.com/channel/UCMLxmbOn9Di_FjRk6rpzPLA"> Youtube</a>
                        </div>
                    </div>
                </div>
            </div>
